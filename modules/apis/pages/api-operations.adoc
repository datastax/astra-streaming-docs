...
Use the following {product} {pulsar-short} Admin API endpoints to manage xref:connectors:index.adoc[sink connectors].
...
Additionally, each connector has different configuration options.
For configuration details, see the documentation for your preferred xref:connectors:index.adoc[sink and source connectors].
====
...
Get a list of sinks deployed in a namespace:
...
The response includes an `instances` array with one object for each connector instance:
...
The response includes a single object with the details for the specified connector instance:
...
Start an individual instance of a sink connector
...
Stop all instances of a sink connector:
...
Stop an individual instance of a sink connector:
...
Restart all instances of a sink connector:
...
Restart an individual instance of a sink connector:
...
Delete all instances of a sink connector from a namespace:
...
Use the following {product} {pulsar-short} Admin API endpoints to xref:connectors:index.adoc[manage source connectors].
...
Get a list of source connectors deployed in a namespace:
...
To create a source connector on a topic, you must provide the xref:connectors:index.adoc[source connector configuration] in JSON format.
You can pass the configuration in-line or with a configuration file.
...
Start an individual instance of a source connector:
...
Restart all instances of a source connector:
...
Restart an individual instance of a source connector:
...
Delete all instances of a source connector from a namespace:
