...
Pulsar's xref:astream-subscriptions-shared.adoc[shared subscription] model enables increased message processing rate, but risks losing message ordering guarantees.
