...
:page-aliases: docs@astra-streaming::astream-dedicated-cluster.adoc
...
* For more on pricing of dedicated clusters, see xref:operations:astream-pricing.adoc[{product_name} Pricing].
