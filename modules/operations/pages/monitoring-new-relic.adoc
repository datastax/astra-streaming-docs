= Configure Astra Streaming metrics integration with New Relic

[NOTE]
====
The method described in this section also applies to integrating Astra Streaming metrics with other cloud observability platforms like https://grafana.com/products/cloud/[Grafana Cloud^]{external-link-icon}.
====
