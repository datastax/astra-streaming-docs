...
. Click *Prometheus* to generate a new `prometheus.yml` configuration file:
+
...
The `job_name` is added as a label to any time series scraped with this configuration.
