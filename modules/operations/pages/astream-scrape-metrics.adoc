...
Prometheus now shows the total incoming Pulsar messages for your {product} cluster.

. To test the integration, produce a few messages in your tenant with the Pulsar CLI or the {product} Websocket.
Make sure your Prometheus graph displays the number of incoming Pulsar messages with each 60 second scrape:
+
