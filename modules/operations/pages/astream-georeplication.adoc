...
. In the {astra_ui}, go to your tenant's **Namespaces and Topics** tab.
...
{product} exposes the following topic-level replication metrics, which can be viewed in the **Overview** section of **Namespaces and Topics** in the {astra_ui}:
