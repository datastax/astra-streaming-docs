...
The below limits are for Pay As You Go clusters.
These limits can be different on <<Dedicated clusters,dedicated clusters>>.

== {product_name} guardrails

Guardrails are initially provisioned in the default settings by {product_name}.
