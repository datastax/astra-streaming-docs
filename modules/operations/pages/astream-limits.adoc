...
[NOTE]
====
The below limits are for Pay As You Go clusters. These limits may be changed on dedicated clusters if necessary. https://support.datastax.com[Contact Support] to change the limits on a dedicated cluster.
====
