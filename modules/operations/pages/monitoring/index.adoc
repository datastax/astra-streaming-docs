...
* https://pulsar.apache.org/docs/reference-metrics/#namespace-metrics[{pulsar-short} Namespace metrics]

* https://pulsar.apache.org/docs/reference-metrics/#topic-metrics[{pulsar-short} Topic metrics]
...
| Namespace
| Gauge
| The number of {pulsar-short} topics of a namespace.
...
| Topic
| Gauge
| The number of {pulsar-short} subscriptions of a topic.
...
This works because {pulsar-short} system topics and namespaces are usually prefixed by two underscores, such as `+persistent://some_tenant/__kafka/__consumer_offsets_partition_0+`.
+
