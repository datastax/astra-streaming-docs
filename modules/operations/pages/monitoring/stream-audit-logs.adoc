...
Stream your xref:astra-db-serverless:administration:audit-log.adoc[{astra} audit logs] through {product} to an external system.
...
----
+
The response should contain the same data as the previous `POST` request body:
+
[source,json]
----
{
