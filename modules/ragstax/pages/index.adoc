= Getting Started with RagStax

The RagStax project combines the intelligence of large language models with the agility of streaming processing, to create powerful processing applications.

This guide will help you connect your RagStax application to Astra Streaming.

RagStax is built with the LangStream framework, which is a set of tools for building Generative AI streaming applications.
...
Select the *Generate LangStream Command* button to generate a CLI configuration file for your tenant.
...
To update these values, use `langstream profiles update astra-langstream-tenant --command-option="value"`.
