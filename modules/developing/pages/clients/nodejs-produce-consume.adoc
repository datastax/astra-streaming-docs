= Use the Node.js Pulsar client with {product}
:navtitle: Node.js
:description: Produce and consume messages with the Node.js Pulsar client and {product}.
:page-tag: astra-streaming,connect,dev,develop,nodejs,pulsar

You can produce and consume messages with the Node.js Pulsar client and {product}.
