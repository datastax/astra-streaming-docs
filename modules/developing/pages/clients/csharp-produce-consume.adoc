= Use the C# Pulsar client on {product}
:navtitle: C#
:description: Produce and consume messages with the C# Pulsar client and {product}.

You can produce and consume messages with the C# Pulsar client and {product}.
