...
This guide assumes you have completed the xref:getting-started:index.adoc[Astra Streaming quickstart], and you have xref:developing:configure-pulsar-env.adoc[set up your Pulsar binaries] to work with your tenant. Now it's time to produce and consume messages in your new streaming tenant.
