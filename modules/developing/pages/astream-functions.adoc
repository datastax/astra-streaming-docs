...
To deploy a function in a sink, xref:streaming-learning:pulsar-io:connectors/index.adoc[create a sink], and include the function in your sink configuration.
