...
----
/testpythonfunction
   "testpythonfunction/testpythonfunction.py"
   "testpythonfunction/test-deployment-package.zip"
   "testpythonfunction/dependencies"
----
...
[source,python]
----
mkdir testpythonfunction
. cd testpythonfunction
. touch testpythonfunction.py
----

. Add your code. For this example, we'll just use a basic exclamation function:
+
[source,python]
----
...
----
testpythonfunction$
| testpythonfunction.py
----

. Run the following command to add testpythonfunction.zip to the root of the file structure:
+
[source,bash]
----
cd testpythonfunction
zip my-deployment-package.zip testpythonfunction.py
  adding: testpythonfunction.py (deflated 28%)
----
...
[source,plain]
----
testpythonfunction ls
my-deployment-package.zip testpythonfunction.py
----

=== Deploying a Python function with configuration file
