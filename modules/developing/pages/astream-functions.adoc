...
You can upgrade your organization to a qualified organization by enrolling in the Pay As You Go plan.
For assistance, open https://support.datastax.com[a support ticket].
...
If you receive an error message with "Reason: only qualified organizations can create functions", this means your organization needs to be upgraded to a Pay As You Go plan to use user-defined functions. For assistance, open https://support.datastax.com[a support ticket].
