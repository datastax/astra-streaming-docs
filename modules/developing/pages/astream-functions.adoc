...
A *qualified organization* is an organization on the Pay As You Go plan with a credit card on file.
Upgrade your organization to a qualified organization by:

* Enrolling in the Pay As You Go plan in the Astra UI with a credit card. For more on available Astra Streaming plans, see the https://docs.datastax.com/en/streaming/astra-streaming/operations/onboarding-faq.html#astra-streaming-environments[Onboarding FAQ].
