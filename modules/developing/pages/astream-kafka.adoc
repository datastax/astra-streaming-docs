...
== {starlight-kafka} Quickstart

. To start connecting {starlight-kafka}, select *Kafka* in the {product} *Connect* tab.
...
+
image::developing:astream-create-kafka-topic.png[Create Kafka Topic]
...
+
image::developing:astream-kafka-monitor.png[Monitor Kafka Activity]

== See also

* https://github.com/datastax/starlight-for-kafka[{company} {starlight-kafka} project]
