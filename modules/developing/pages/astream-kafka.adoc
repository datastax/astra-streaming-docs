...
. Select *Enable Kafka*.
+
Three new namespaces are created in your {product} tenant:
+
...
. Send as many messages as you'd like, then return to your `kafka` namespace dashboard in {product} and monitor your activity.
