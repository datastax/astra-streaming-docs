...
:page-aliases: docs@astra-streaming::astream-kafka.adoc
...
For more on {product_name}, see xref:getting-started:astream-quick-start.adoc[{product_name} Quickstart].
