...
:page alias: docs@astra-streaming::astream-cdc.adoc
...
[NOTE]
====
Enabling CDC for {astra_db} will result in increased costs based on your {astra_stream} usage. See xref:astream-pricing.adoc[Astra Streaming Pricing] and the https://www.datastax.com/products/datastax-astra/cdc-for-astra-db[Astra CDC pricing page].
====
...
[NOTE]
====
{product_name} CDC can only be used in a region that supports both {product_name} and Astra DB. See xref:astream-regions.adoc[Regions] for more information.
====
