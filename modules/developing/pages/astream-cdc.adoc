...
See https://www.datastax.com/products/astra-streaming/pricing[Astra Streaming pricing^]{external-link-icon} for {astra_stream} pricing and  https://www.datastax.com/products/datastax-astra/cdc-for-astra-db[CDC for Astra DB^]{external-link-icon} for metering rates.
====
