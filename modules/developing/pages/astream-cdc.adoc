...
You can use xref:connectors:index.adoc[other {astra-stream} sinks].
...
If your database is deployed to an xref:astra-db-serverless:databases:regions.adoc[{astra-db} region] that doesn't yet support {astra-stream}, contact your {company} account representative or {support-url}[IBM Support].
...
+
If your database is deployed to a region that doesn't support {astra-stream}, contact your {company} account representative or {support-url}[IBM Support].
