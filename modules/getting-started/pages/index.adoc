...
Follow this guide to create an Astra account and use it to create a streaming tenant where streaming messages are produced and consumed.
...
+
--
. Once signed in, click the "Create a Stream" button on the Astra home page.
+
|===
...
|
xref:clients/index.adoc[Runtime Clients] +
