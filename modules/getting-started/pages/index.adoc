...
{product} is a serverless data streaming and event stream processing service integrated in the {astra_ui} and powered by {pulsar-reg}.
...
* Sign in or create an {url-astra}[{astra_db} account^].
